...
{
    public ServicioFacturacionCodigosClient(string token, string url = "https://pilotosiatservicios.impuestos.gob.bo/v2/FacturacionCodigos") : base(GetDefaultBinding(), new EndpointAddress(url)) =>
