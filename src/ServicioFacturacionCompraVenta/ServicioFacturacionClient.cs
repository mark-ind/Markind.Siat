...
public partial class ServicioFacturacionClient
{
    ...
    public respuestaRecepcion recepcionAnexos() => recepcionAnexos(DefaultMessage);
    public respuestaRecepcion recepcionAnexos(Message msg) => recepcionAnexos(DefaultMessage.Merge(msg));
    public Task<recepcionAnexosResponse> recepcionAnexosAsync() => recepcionAnexosAsync(DefaultMessage);
    public Task<recepcionAnexosResponse> recepcionAnexosAsync(Message msg) => recepcionAnexosAsync(DefaultMessage.Merge(msg));
